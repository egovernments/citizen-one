...
import 'package:edge_client/models/connection/tenant_boundary.dart';
...
import 'package:edge_client/models/mdms/category_type.dart';
import 'package:edge_client/models/mdms/connection_type.dart';
import 'package:edge_client/models/mdms/property_type.dart';
import 'package:edge_client/models/mdms/sub_category_type.dart';
import 'package:edge_client/providers/common_provider.dart';
import 'package:edge_client/repository/billing_service_repo.dart';
import 'package:edge_client/repository/consumer_details_repo.dart';
import 'package:edge_client/repository/core_repo.dart';
import 'package:edge_client/repository/search_connection_repo.dart';
import 'package:edge_client/service/utils/MDMS.dart';
import 'package:edge_client/utils/classes_model.dart';
...
import 'package:egov_widgets/widgets/dialog.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:edge_client/models/connection/water_connection.dart' as addition;

import '../modules/water_service/ConsumerDetails/ConsumerDetailsWalkThrough/walkthrough.dart';

class ConsumerProvider with ChangeNotifier, HelperMethods {
...
//Displaying ConnectionType data Fetched From MDMD (Ex Metered, Non Metered..)
  ...
  List<DropdownMenuItem<Object>> getBillingCycle() {
    ...
    if (languageList?.mdmsRes?.taxPeriodList!.TaxPeriodList! != null &&
      ...
      var months = getPastMonthUntilFinancialYear(date1.year);
